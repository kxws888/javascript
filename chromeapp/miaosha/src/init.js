(function () {
    ...
    var configsBox = createUI(), queryStr, reg = /\d+(,\d+)?(\.\d+)?/, colors = ['#f00', '#0f0', '#00f'], i = 1;

    document.documentElement.style['-webkit-box-shadow'] = 'inset 0px 50px 200px #f00';
    setInterval(function () {
        document.documentElement.style['-webkit-box-shadow'] = 'inset 0px 5px 80px ' + colors[i = i++ > colors.length ? 0 : i]
    }, 2000);
